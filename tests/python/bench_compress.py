...
def benchmark_compress():
    ...
    @register_method
    def itertools_compress(items):
        return list(it.compress(items, items))
    ...
    basis = {
        ...
        'n': [1, 2, 3, 5, 10, 30, 50, 100, 300, 500, 1000, 3000, 5000],
...
if __name__ == '__main__':
    """
    CommandLine:
        python ~/misc/tests/python/bench_compress.py
    """
    benchmark_compress()
