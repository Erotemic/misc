...
def main():
    ...
    for kw2 in gridsearch(basis2):
        ...
        ave_speedup = results['speedup_2021_wrt_2017'].mean()
        ave_speedups.append(ave_speedup)
    total_ave_speedup = np.mean(ave_speedups)
    print('total_ave_speedup = {!r}'.format(total_ave_speedup))
